package com.broserver.bs.config;
...
@Configuration
@EnableJpaRepositories("com.broserver.bs.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.broserver.bs.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.broserver.bs.config.HerokuDatabaseConfiguration")
